        ...
        try {
          const appraisal = await prisma.appraisal.upsert({
            ...
            update: {
              ...
              ownerOccupiedUnits: prop.ownerOccupiedUnits,
              tenantOccupiedUnits: prop.tenantOccupiedUnits,
              unitsInspected: prop.unitsInspected,
              separatelyMetered: prop.separatelyMetered,
              status: 'draft',
              updatedAt: new Date(),
            },
            create: {
